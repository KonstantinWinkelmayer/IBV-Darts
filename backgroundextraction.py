...
parser.add_argument('--input', type=str, help='Path to a single image, a sequence of images, or a GIF.', default='Bild_all/*.jpg')
parser.add_argument('--algo', type=str, help='Background subtraction method (KNN, MOG2).', default='MOG2')
parser.add_argument('--speed', type=int, help='Speed of the GIF playback in milliseconds.', default=1000)
...
while True:
    for idx, frame in enumerate(frames):
        ...
        keyboard = cv.waitKey(args.speed)
